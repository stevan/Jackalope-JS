...
Jackalope.Client.Binding.Action.prototype = {
    ...
    "set_target_data" : function ( target_data ) {
        this.clear_target();
...
// ----------------------------------------------------------------------------
// Jackalope Client Binding Action button
// ----------------------------------------------------------------------------
// This extends the Binding Action to be more button specific
// ----------------------------------------------------------------------------

Jackalope.Client.Binding.Action.Button = function ( opts ) { this.init( opts ) };
Jackalope.Client.Binding.Action.Button.prototype = new Jackalope.Client.Binding.Action ();
Jackalope.Client.Binding.Action.Button.prototype.disable = function () {
    this.$element().attr('disabled', true);
}
Jackalope.Client.Binding.Action.Button.prototype.enable = function () {
