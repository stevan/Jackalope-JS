...
Jackalope.Client.View.Form.prototype.init = function ( opts ) {
    ...
    if ( opts["target_action"] != undefined ) {
        this.target_action = opts['target_action'];
    }
    if ( opts["cancel_action"] != undefined ) {
        this.cancel_action = opts['cancel_action'];
    }
...
Jackalope.Client.View.Form.prototype.set_target_data = function ( target_data ) {
    this.target = target_data.target;
    // optionally set the other stuff as well ...
    if ( target_data.action != undefined ) {
        this.target_action = target_data.action;
    }
    if ( target_data.cancel != undefined ) {
        this.cancel_action = target_data.cancel;
    }
};
...
Jackalope.Client.View.Form.prototype.reset_form = function () {
    ...
    this.target[ this.cancel_action ].apply( this.target, [ this.form_data ] );
};
